...
;;       fixed mains use of perameters vs local variables(ugg) 
...
main:    SUBSP 12, i ;alloc #donFlg #command #num2 #num1 #vector0 #size0 
         LDA 0, i 
         STA heap, d
;int size;
         LDA 0, i
...
else0:   STRO error1, d         
         ...
         DECO MAXLEN, i
         ;return;
         ADDSP 12, i ;dealloc #size0 #vector0 #num1 #num2 #command #donFlg
         RET0
;}//else 

;prinVect(size, vector
doneIf0: CALL prinVect, i
;char command
...
default:                    STRO prompt6, d
         ...
         ;prinVect(size, vector);
break:           CALL prinVect, i
                 BR while0, i
;}//while
    
;}//main
dneWhil: ADDSP 12, i;dealloc #size0 #vector0 #num1 #num2 #command #donFlg 
         RET0
